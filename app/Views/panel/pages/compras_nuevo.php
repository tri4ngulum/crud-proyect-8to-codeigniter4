        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <?= form_open_multipart("registrar_compra", ['id' => 'form-compras']); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    if ($session->rol_actual == ROL_USUARIO["clave"]) {
                                        ...
                                        $html = '    <label for="exampleInputEmail1">Id del usuario</label>';
                                        $parametro = array('class' => 'form-control', 'id' => 'id_usuario', 'name' => 'id_usuario');
                                        echo $html;
                                        echo form_dropdown("id_usuario", ["" => "Selecciona un usuario"] + $id_usuarios, array(), $parametro);
                                    }
                                    ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown("id_boleto", ["" => "Selecciona un boleto"] + $id_boletos, array(), $parametro);
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                if ($session->rol_actual == ROL_USUARIO["clave"]) {
                                    ...
                                    $html = '<label for="exampleInputEmail1">Precio Boleto</label>';
                                    $data = [
                                        'name' => 'precio_boleto',
                                        'class' => 'form-control',
                                        'type' => 'number',
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown("id_metodoPago", ["" => "Selecciona un metodo de pago"] + $id_metodopagos, array(), $parametro);
                                ?>
...
<script src="<?= base_url(RECURSOS_ESPECIFICO . '/compras_nuevo.js'); ?>" )></script>
