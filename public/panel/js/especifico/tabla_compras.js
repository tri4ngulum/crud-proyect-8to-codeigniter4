...
$(document).on('click', '.estatus', function() {
    ...
    let array = [id, estatus, ' a esta compra', 'Este acción será permanente.'];
    let url = path + '/estatus_compra/' + id + '/' + estatus;
    cambiar_estatus(url, array, 'warning');
})

$(document).on('click', '.eliminar', function() {
    let id = $(this).attr('id');
    let array = ['a la compra ', 'Este acción será permanente.' ];
    let url = path + '/eliminar_compra/' + id;
